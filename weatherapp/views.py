...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=2e09719a0ecd67060042124d4da2af43'

    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyCZTNbg5yrQ-tikQFxek3tZ0MaTV1DMek4'

    SEARCH_ENGINE_ID = '66c46e33305474cad'
